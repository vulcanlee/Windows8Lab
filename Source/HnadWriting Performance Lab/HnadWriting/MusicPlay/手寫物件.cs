...
namespace HnadWriting
{
    ...
    public class 手寫物件軌跡
    {
        ...
        public SolidColorBrush 取得手寫物件調色盤的實際SolidColorBrush()
        {
            SolidColorBrush solidColorBrush = null;
            ...
            switch (this.手寫物件調色盤)
            {
                case 手寫物件調色盤.img_color_black:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("ff1a1a1a"));
                    break;
                case 手寫物件調色盤.img_color_gray:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("ff999999"));
                    break;
                case 手寫物件調色盤.img_color_r:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("ffff0000"));
                    break;
                case 手寫物件調色盤.img_color_b:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("ff006cff"));
                    break;
                case 手寫物件調色盤.img_color_g:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("ff0da522"));
                    break;
                case 手寫物件調色盤.img_opacity_b:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("6627e8ff"));
                    break;
                case 手寫物件調色盤.img_opacity_g:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("66999999"));
                    break;
                case 手寫物件調色盤.img_opacity_r:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("66ff0000"));
                    break;
                case 手寫物件調色盤.img_opacity_o:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("66ffa200"));
                    break;
                case 手寫物件調色盤.img_opacity_y:
                    solidColorBrush = new SolidColorBrush(ColorsHelper.Parse("66ffea00"));
                    break;
                default:
                    break;
            }
